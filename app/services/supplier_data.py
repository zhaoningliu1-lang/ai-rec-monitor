...
TARIFF_TABLE: dict[str, TariffInfo] = {
    ...
    # ── Additional HS codes (expanded coverage) ──
    "8516.40": TariffInfo("8516.40", "Electric smoothing irons",
                          3.4, 25.0, "List 3 Section 301"),
    "8509.40": TariffInfo("8509.40", "Food grinders, blenders, juicers",
                          3.4, 25.0, "List 3 Section 301"),
    "8516.10": TariffInfo("8516.10", "Electric instantaneous/storage water heaters",
                          3.9, 25.0, "List 3 Section 301"),
    "7323.99": TariffInfo("7323.99", "Iron/steel household articles (other)",
                          3.4, 7.5, "List 4A Section 301"),
    "7615.20": TariffInfo("7615.20", "Aluminum sanitary ware",
                          3.1, 7.5, "List 4A Section 301"),
    "9617.00": TariffInfo("9617.00", "Vacuum flasks & bottles",
                          7.2, 7.5, "List 4A Section 301"),
    "6302.60": TariffInfo("6302.60", "Cotton toilet/kitchen linen",
                          9.1, 7.5, "List 4A Section 301"),
    "9404.21": TariffInfo("9404.21", "Mattresses of cellular rubber/plastics",
                          3.0, 7.5, "List 4A Section 301"),
    "8414.51": TariffInfo("8414.51", "Table/floor fans with motor ≤125W",
                          4.7, 25.0, "List 3 Section 301"),
    "8516.71": TariffInfo("8516.71", "Electro-thermic coffee/tea makers",
                          3.4, 25.0, "List 3 Section 301"),
    "3926.90": TariffInfo("3926.90", "Other articles of plastics",
                          5.3, 7.5, "List 4A Section 301"),
    "4419.12": TariffInfo("4419.12", "Bamboo cutting boards & kitchenware",
                          3.2, 7.5, "List 4A Section 301"),
}
