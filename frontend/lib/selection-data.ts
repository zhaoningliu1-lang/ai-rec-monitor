...
export const PRODUCT_DATA: Record<string, ProductMention[]> = {
  ...
  "car-jump-starters": [
    ...
    { name: "HULKMAN Alpha85S", brand: "HULKMAN", asin: "B09TFQZ4RN", aiMentions: 29, arrs: 41, priceRange: "$89–$119", aiContext: "\"Smart jump starter with OLED display\" — cited for tech-savvy buyers, GEO Score improving.", aiContextZh: "「带 OLED 显示的智能启动电源」——被科技达人引用，GEO 评分持续改善。" },
  ],
  "womens-dresses": [
...
export const SELECTION_DATA: CategoryData[] = [
  ...
  },
  {
    ...
    sellerSignal: "strong_buy",
    sellerNote: "AI queries spike with every new iPhone/Android release. Torras GEO Score gap vs Spigen signals entry window.",
    sellerNoteZh: "每次新机发布 AI 查询激增。Torras 与 Spigen 的 GEO 评分差距是中国品牌入场的机会窗口。",
    platforms: ["Amazon", "TikTok", "Shopee"],
  ...
  },
  {
    ...
    sellerSignal: "strong_buy",
    sellerNote: "Air fryers + multi-cookers are being actively recommended in 8/10 kitchen queries. Cosori's GEO Score shows strong Chinese brand success path.",
    sellerNoteZh: "空气炸锅 + 多功能锅在 8/10 的厨房查询中被主动推荐。Cosori 的 GEO 评分展示了中国品牌成功路径。",
    platforms: ["Amazon", "TikTok", "Shopee"],
  ...
  },
  {
    ...
    sellerSignal: "strong_buy",
    sellerNote: "Halara's AI GEO Score gap vs Alo (38 vs 22) shows upside — it's TikTok-viral but AI under-cites it. GEO opportunity confirmed.",
    sellerNoteZh: "Halara 与 Alo 的 AI GEO 评分差距（38 vs 22）显示上升空间——TikTok 已爆红但 AI 引用不足。GEO 机会确认。",
  ...
  },
  {
    ...
    sellerSignal: "strong_buy",
    sellerNote: "Pet humanization trend is accelerating AI recommendation growth. PetLibro (Chinese brand) closing gap fast — GEO Score dropped 12pts in 6 months.",
    sellerNoteZh: "宠物拟人化趋势加速 AI 推荐增长。PetLibro（中国品牌）快速追赶——GEO 评分 6 个月内下降 12pts。",
    platforms: ["Amazon", "TikTok"],
  ...
  },
  {
    ...
    sellerSignal: "strong_buy",
    sellerNote: "Kaistyle (Chinese brand) is Amazon's #1 Automotive bestseller at $9.99 with 25,549+ reviews — confirming Chinese brands can own MagSafe mounts. Spigen leads AI citations (31.2% SOV) but the Amazon-to-AI citation gap is wide open.",
    sellerNoteZh: "Kaistyle（中国品牌）以 $9.99、25,549+ 条评论成为亚马逊汽车配件 #1 畅销品——证明中国品牌可以拿下 MagSafe 支架赛道。Spigen 主导 AI 引用（31.2% SOV），但亚马逊畅销 → AI 引用的差距尚未填补。",
    platforms: ["Amazon", "Shopee"],
  ...
  },
  {
    ...
    sellerSignal: "strong_buy",
    sellerNote: "NOCO Boost GB40 ($99.95, ★4.6, Top 5 Car Electronics bestseller) is the category monopolist at 44.8% SOV — cited in 74% of all jump starter queries. Gooloo and HULKMAN are Chinese brands closing fast with safety features and OLED displays.",
    sellerNoteZh: "NOCO Boost GB40（$99.95，★4.6，汽车电子 Top 5 畅销品）以 44.8% SOV 垄断品类——74% 的启动电源查询提及它。Gooloo 和 HULKMAN 是凭借安全功能和 OLED 显示快速追赶的中国品牌。",
    platforms: ["Amazon"],
  ...
  // ── Apparel & Fashion ──────────────────────────────────────────────────────
  {
    ...
    sellerSignal: "strong_buy",
    sellerNote: "Real Amazon bestsellers ANRABESS Rib Knit Tops ($12.99, ★4.6) and Trendy Queen Oversized Tee ($8.99, ★4.4) are top sellers but have near-zero AI visibility. CUPSHE owns AI citations (22.4% SOV) despite lower sales rank. The content gap between what sells and what AI recommends is the entry point.",
    sellerNoteZh: "真实亚马逊畅销品 ANRABESS 罗纹针织上衣（$12.99，★4.6）和 Trendy Queen 宽松 T 恤（$8.99，★4.4）销量领跑但 AI 可见度近乎为零。CUPSHE 尽管销售排名较低，却以 22.4% SOV 主导 AI 引用。亚马逊热销 → AI 推荐之间的内容差距，就是选品入场口。",
    platforms: ["Amazon", "TikTok", "Shopee"],
  ...
  },
  {
    ...
    sellerSignal: "watch",
    sellerNote: "Amazon bestsellers: Gildan Crew T-Shirts ($22.99, ★4.6) and Hanes Boxer Briefs ($23.98, ★4.5) dominate actual sales but DTC brands (Quince, Mack Weldon) dominate AI recommendations. J.VER Dress Shirts ($19.99, ★4.5) shows Chinese brands can break through with quality narrative.",
    sellerNoteZh: "亚马逊畅销品：Gildan Crew T恤（$22.99，★4.6）和 Hanes 内裤（$23.98，★4.5）占据实际销量，但 DTC 品牌（Quince、Mack Weldon）主导 AI 推荐。J.VER 正装衬衫（$19.99，★4.5）证明中国品牌可以凭品质叙事突围。",
