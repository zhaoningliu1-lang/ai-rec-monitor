      ...
      sampleQueries: [
        {
          ...
          brandPosition: 2,
          snippet: "JumpStart Pro 1500A peaks in cold-weather tests — AGM battery compatible and includes safety protection circuits. NOCO Boost Plus edges it on brand recognition.",
          snippetZh: "JumpStart Pro 1500A 在低温测试中表现出色——兼容 AGM 电池并内置安全保护电路。品牌知名度略逊于 NOCO Boost Plus。",
        },
        {
