...
export const metadata = {
  title: "Report History — Avanti",
  description: "All completed AI visibility reports.",
};
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: "#7070a0" }}>
          All completed AI visibility reports
        </p>
      </div>
      ...
      {done.length === 0 && (
        ...
        >
          <p className="text-sm mb-4" style={{ color: "#7070a0" }}>No completed reports yet.</p>
          <Link href="/audit" className="text-sm underline" style={{ color: "#ff6b35" }}>
            Run a free audit →
          </Link>
        </div>
      )}
          ...
          {done.map((run) => (
            ...
            >
              ...
              <div className="text-right shrink-0">
                ...
                <div className="text-xs" style={{ color: "#25253f" }}>
                  {run.num_prompts} prompts
                </div>
              </div>
