...
export const metadata = {
  title: "户外运动 AI 可见度报告 — 2026年3月 | 阿凡提",
  description: "户外运动品类的全面 AI 可见度分析。我们在 ChatGPT、Claude、Gemini 和 Perplexity 上分析了 200 多个查询，绘制了品牌推荐份额、推荐模式和优化机会。",
};
    ...
    <div className="max-w-3xl mx-auto py-16 px-4 space-y-12">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2 mt-3">
          <span className="text-xs px-2.5 py-0.5 rounded-full font-medium" style={{ background: "rgba(52,211,153,0.12)", color: "#34d399" }}>户外运动</span>
          <span className="text-xs" style={{ color: "#7070a0" }}>2026年3月7日 · 阅读时长 10 分钟</span>
        </div>
        <h1 className="text-3xl font-bold leading-tight">户外运动 AI 可见度报告 — 2026年3月</h1>
        <p className="text-base leading-relaxed" style={{ color: "#7070a0" }}>户外运动品类的全面 AI 可见度分析。我们在 ChatGPT、Claude、Gemini 和 Perplexity 上分析了 200 多个查询，绘制了品牌推荐份额、推荐模式和优化机会。</p>
      </div>

      {/* Key Stats */}
      <div className="rounded-xl p-6 space-y-4" style={{ background: "#0f0f17", border: "1px solid #34d399" }}>
        <div className="text-xs font-bold uppercase tracking-widest" style={{ color: "#34d399" }}>核心指标</div>
      ...
      <div className="space-y-4">
        ...
        {"全球户外运动市场持续增长，受跨境电商扩张和 AI 影响的购买决策推动。主要趋势包括消费者越来越依赖 AI 助手进行产品研究、品牌发现从传统搜索转向对话式 AI、以及 AI 可见度对新市场进入者日益重要。\n\n值得注意的是，该品类中超过 40% 的产品研究查询现在至少涉及一个 AI 引擎，高于 2025 年初的 22%。没有刻意 AI 可见度策略的品牌，面临着对快速增长的高意向买家群体隐形的风险。".split("\n\n").map((p, i) => (
