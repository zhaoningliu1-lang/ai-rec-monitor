...
export const metadata = {
  title: "AI 投毒 vs AI 可见度管理：阿凡提的立场 | 阿凡提",
  description:
    "2026 年央视 3.15 晚会曝光了 AI 数据投毒灰产。阿凡提声明：我们监测，不操纵。了解 AI 投毒与正当 AI 可见度管理的本质区别。",
};

export default function ZhAIPoisoningVsVisibilityPage() {
  return (
    <div className="max-w-3xl mx-auto py-16 px-4 space-y-12">
      ...
      {/* What happened */}
      <div className="space-y-4">
        <h2 className="text-xl font-bold">3.15 晚会曝光了什么</h2>
        <div
      ...
      <div className="space-y-6">
        <h2 className="text-xl font-bold">阿凡提做什么，不做什么</h2>
      ...
      <div className="space-y-6">
        <h2 className="text-xl font-bold">投毒 vs 正当优化：本质区别</h2>
      ...
      {/* Why this matters */}
      <div className="space-y-6">
        <h2 className="text-xl font-bold">为什么品牌方必须关注这件事</h2>
      ...
      {/* What Avanti offers */}
      <div className="space-y-6">
        <h2 className="text-xl font-bold">阿凡提如何保护你的品牌</h2>
          ...
          {[
            {
              icon: "\uD83D\uDD0D",
              title: "AI 可见度监控",
              titleEn: "AI Visibility Monitoring",
            ...
            },
            {
              icon: "\u26A0\uFE0F",
              title: "AI 幻觉检测",
              titleEn: "Hallucination Detection",
            ...
            },
            {
              icon: "\u2705",
              title: "跨平台交叉验证",
              titleEn: "Cross-Platform Verification",
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs font-medium mt-0.5" style={{ color: "#7070a0" }}>
                  {feature.titleEn}
                </div>
              </div>
              <p className="text-xs leading-relaxed" style={{ color: "#7070a0" }}>
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-bold">3.15 曝光恰恰验证了我们在做的事</h2>
        <div
      ...
      {/* Our commitment */}
      <div className="space-y-4">
        <h2 className="text-xl font-bold">我们的承诺</h2>
        <div className="space-y-3">
          {[
            {
              title: "透明",
