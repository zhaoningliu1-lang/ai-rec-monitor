...
export const metadata = {
  title: "Electronics AI Visibility Report — March 2026 | Avanti",
  description: "Comprehensive AI visibility analysis of the electronics category. We analyzed 200+ queries across ChatGPT, Claude, Gemini & Perplexity to map brand share-of-voice, recommendation patterns, and optimization opportunities.",
};
    ...
    <div className="max-w-3xl mx-auto py-16 px-4 space-y-12">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2 mt-3">
          <span className="text-xs px-2.5 py-0.5 rounded-full font-medium" style={{ background: "rgba(96,165,250,0.12)", color: "#60a5fa" }}>Electronics</span>
          <span className="text-xs" style={{ color: "#7070a0" }}>March 8, 2026 · 10 min read</span>
        </div>
        <h1 className="text-3xl font-bold leading-tight">Electronics AI Visibility Report — March 2026</h1>
        <p className="text-base leading-relaxed" style={{ color: "#7070a0" }}>Comprehensive AI visibility analysis of the electronics category. We analyzed 200+ queries across ChatGPT, Claude, Gemini & Perplexity to map brand share-of-voice, recommendation patterns, and optimization opportunities.</p>
      </div>

      {/* Key Stats */}
      <div className="rounded-xl p-6 space-y-4" style={{ background: "#0f0f17", border: "1px solid #60a5fa" }}>
        <div className="text-xs font-bold uppercase tracking-widest" style={{ color: "#60a5fa" }}>Key Metrics</div>
