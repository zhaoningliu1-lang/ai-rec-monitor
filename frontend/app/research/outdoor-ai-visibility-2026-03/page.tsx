...
export const metadata = {
  title: "Outdoor Sports AI Visibility Report — March 2026 | Avanti",
  description: "Comprehensive AI visibility analysis of the outdoor sports category. We analyzed 200+ queries across ChatGPT, Claude, Gemini & Perplexity to map brand share-of-voice, recommendation patterns, and optimization opportunities.",
};
    ...
    <div className="max-w-3xl mx-auto py-16 px-4 space-y-12">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2 mt-3">
          <span className="text-xs px-2.5 py-0.5 rounded-full font-medium" style={{ background: "rgba(52,211,153,0.12)", color: "#34d399" }}>Outdoor Sports</span>
          <span className="text-xs" style={{ color: "#7070a0" }}>March 7, 2026 · 10 min read</span>
        </div>
        <h1 className="text-3xl font-bold leading-tight">Outdoor Sports AI Visibility Report — March 2026</h1>
        <p className="text-base leading-relaxed" style={{ color: "#7070a0" }}>Comprehensive AI visibility analysis of the outdoor sports category. We analyzed 200+ queries across ChatGPT, Claude, Gemini & Perplexity to map brand share-of-voice, recommendation patterns, and optimization opportunities.</p>
      </div>

      {/* Key Stats */}
      <div className="rounded-xl p-6 space-y-4" style={{ background: "#0f0f17", border: "1px solid #34d399" }}>
        <div className="text-xs font-bold uppercase tracking-widest" style={{ color: "#34d399" }}>Key Metrics</div>
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div className="space-y-1">
            <div className="text-2xl font-black" style={{ color: "#34d399" }}>58%</div>
